...
Consola.prototype.start = function () {
    ...
    this.filtro_entrada_serializado = {};
    this.div_filtro_entrada.jsonEditor({}, { change: function (json) {
        _this.filtro_entrada_serializado = json;
    }});
    ...
    this.btn_actualizar_filtro_entrada.click(function () {
        try {
            var filtro = DesSerializadorDeFiltros.desSerializarFiltro(_this.filtro_entrada_serializado);
